            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <form id="formmethoed" action="viewstaff.php" method="POST">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <?php
                                $sql = "SELECT *,
                                (SELECT `name` FROM policestation WHERE policestation.id = staffinfo.policestationid) pstation
                                 FROM staffinfo WHERE policestationid = '$policeid' AND status='1'";
                                $result = $conn->query($sql);
                                if ($result->num_rows > 0) {
                                    while($row         = $result->fetch_assoc()) {
                                        $id             = $row["id"];
									 ...
									 ?>                                   
                                        <tr> 
                                            ...
                                            <td><?php echo $pstation;?></td> 
                                            <td><a href="function/deletestaff.php?staffid=<?php echo $id;?> ">Delete</a></td> 
                                        </tr> 
                                <?php
