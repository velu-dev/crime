            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form class="form-horizontal" method="post" action="function/addfir.php">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="input-group input-group-lg">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Enter Adddress" name="address">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="input-group input-group-lg">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Reson for Complaint" name="reason">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Against Name" name="against" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Discription" name="description">
                                        </div>
                                    </div>
                                </div>
                            </div>
